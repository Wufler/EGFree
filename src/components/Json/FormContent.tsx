...
const optionCheckboxClass =
  "border-input has-data-checked:border-primary/50 has-data-checked:bg-primary/5 has-data-[state=checked]:border-primary/50 has-data-[state=checked]:bg-primary/5 w-full cursor-pointer items-center justify-between gap-3 rounded-lg border p-3.5 shadow-none outline-none bg-background transition-all hover:bg-accent/50 hover:border-primary/50";
...
export default function JsonFormContent({
  ...
  return (
    <div className="w-full">
      <Tabs defaultValue="discord" className="w-full gap-0">
        <TabsList className="grid w-full grid-cols-3 rounded-none border-b border-border bg-muted/30 p-1">
        ...
        >
          <Card className="bg-background border-none overflow-hidden rounded-none p-0 pb-6 ring-0">
                        ...
                        <AlertDialogContent className="z-80 border-primary/20 shadow-2xl">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="space-y-2 text-base">
                              <div>
                                <p>
                                  This will encrypt and save your webhook in
                                  your browser&apos;s local storage and will
                                  automatically populate the URL input.
                                </p>
                                <p className="font-semibold text-foreground text-sm">
                                  Consider manually pasting the webhook as a
                                  safer alternative.
                                </p>
                              </div>
                            </AlertDialogDescription>
                  ...
                  <>
                    ...
                    <div className="flex items-center ring-1 ring-input rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-primary transition-all">
                      <Input
                        ...
                        className={`border-0 rounded-none focus-visible:ring-0 text-sm ${
                          webhookUrlMobile &&
                          !isValidDiscordWebhook(webhookUrlMobile)
                            ? "text-red-500"
                            : ""
                        }`}
                      />
                        ...
                        <AlertDialogContent className="z-80 border-primary/20 shadow-2xl">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="space-y-2 text-base">
                              <div>
                                <p>
                                  This will encrypt and save your mobile webhook
                  ...
                  <>
                    <div className="space-y-2 sm:col-span-2">
                          ...
                          onClick={async () => {
                            try {
                              ...
                              if (/^\d+$/.test(text)) {
                                ...
                                toast.error(
                                  "Clipboard content must be a role ID",
                                );
                              }
                            } catch {
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          updateSetting("embedContent", e.target.value)
                        }
        ...
        <TabsContent
          ...
          className="space-y-4 focus-visible:outline-none focus-visible:ring-0 mt-0"
        >
          <Card className="bg-background border-none overflow-hidden rounded-none p-0 pb-6 ring-0 gap-4">
            <CardHeader className="bg-muted/20 py-4 px-6 border-b border-border">
              <CardTitle className="text-base font-semibold flex items-center gap-2">
                Appearance
              </CardTitle>
