        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3 right-3 rounded-full size-8 p-0 bg-black/50 hover:bg-black/70 text-white backdrop-blur-md z-50 flex items-center justify-center transition-all"
                size="icon"
              />
            }
          >
